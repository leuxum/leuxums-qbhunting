...
VERSION : 0.1 UPDATE 0.2 COMING TONIGHT AND WILL INCLUDE THE FOLLOWING
- DIFFERENT ITEMS DEPENDANT ON THE ANIMAL EG ALL WILL GIVE YOU VERSIONS OF THEIR CARCASS FOR EXAMPLE DEER CARCASS BOAR CARCASS ETC
- POACHING AT CAYO PERICO WITH SELECT ANIMALS
ANIMALS INCLUDE : CHIMPANZEE, GREY CHIMPANZEE, HUSKY AND A 1 IN 10 CHANCE OF BIGFOOT (BIGFOOT HAS A 1 IN 25 CHANCE TO GIVE YOU HIS FUR WHEN YOU SKIN HIM AND WILL GIVE HIGHER PRICES)
- SECRET SHOP FOR SOME POACHING EQUIPTMENT
- 20 NEW ITEMS FOR SHARED.LUA
- CLEANUP OF THE ENTIRE SCRIPT
