local carcasses = {
    ...
    { name = "deercarcass2", price = 195, illegal = false },
    { name = "deercarcass3", price = 275, illegal = false },
    { name = "deercarcass4", price = 350, illegal = false },
    { name = "boarcarcass1", price = 50, illegal = false },
    { name = "boarcarcass2", price = 50, illegal = false },
    { name = "boarcarcass3", price = 50, illegal = false },
    { name = "boarcarcass4", price = 50, illegal = false },
    { name = "wolfcarcass1", price = 50, illegal = false },
}
